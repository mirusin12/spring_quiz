...
<body>
	<div class="container">
		...
		<div class="form-group">
			...
			<small id="duplicationText" class="text-danget d-none">중복된 URL 입니다.</small>
	...
	$(document).ready(function() {
		...
		$("#duplicationBtn").on('click', function() {
			...
			$.ajax({
				// request
				type:"POST"
				, url:"/quizTry1/is-duplication-url"
				, data:{"url":url}
				// response
		...
		$("#addBtn").on('click', function() {
			...
			$.ajax({
				...
				, success:function(data) { // data: JSON String => parsing(jquery ajax가) => js dictionary
					...
					if (data.code == 200) {
						// 목록 화면으로 이동 GET
						location.href="/quizTry1/bookmark-list-view"
					}
				}
